    ...
    <div className='min-h-screen w-screen bg-moon pl-32 pr-32 pt-12 '>
       <div className='flex justify-between items-center flex-row'>
           <div className='flex flex-col '>
                <div className='text-[5.75rem] text-white font-bold'>
                ...
                <div className='text-6xl text-white font-semibold pt-1'>
                   & backend developer<span className='text-rose'>.</span>
                </div> 
                <div className='text-xl text-peri font-bold pt-8 '>
                   stick around to see some of my work
                </div> 
                <div className='pt-8'>
                <Button  name='See my work' route={"/"} />
                </div>
            </div>
            <Image src={HeroImg} />
        </div> 
